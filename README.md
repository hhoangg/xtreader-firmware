...
1. Connect your device to your computer via USB-C and wake/unlock the device
2. Download the firmware file for your device from [Releases](https://github.com/hhoangg/xtreader-firmware/releases), or compile yourself.
...
2. Download the firmware file for your device from the [releases page](https://github.com/hhoangg/xtreader-firmware/releases).
