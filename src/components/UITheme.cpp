...
#include "components/themes/sheet/SheetTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::SHEET:
      LOG_DBG("UI", "Using Sheet theme");
      currentTheme = std::make_unique<SheetTheme>();
      currentMetrics = &SheetMetrics::values;
      break;
  }
  metricsValid = false;
}
